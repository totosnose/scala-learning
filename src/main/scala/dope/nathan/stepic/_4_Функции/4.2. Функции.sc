...
// Лямбда-абстрация
// задать значение (определить функцию)
// можно с помощью лямбда-выражений
...
// функции м.б. использованы везде,
// где м.б. использованы обычные значения =>
...
// функцию от 1го параметра, которая ... и т.д. и в конце - результат
// или
